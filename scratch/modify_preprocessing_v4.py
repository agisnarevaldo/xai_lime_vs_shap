...
def modify_preprocessing_v4():
    filepath = "02_preprocessing_prdect.ipynb"
    with open(filepath, 'r', encoding='utf-8') as f:
        nb = json.load(f)
    
    # Cell 9: Apply Cleaning, Label Mapping, Deduplication, and set DROP_CONFLICTS = False
    cell_9 = nb['cells'][9]
    cell_9_source = [
        ...
        "DROP_CONFLICTS = False  # Set to False (default) to keep the first occurrence of conflicting duplicates\n",
        "before_drop = len(df)\n",
        "if DROP_CONFLICTS:\n",
    ...
    print("Successfully reverted DROP_CONFLICTS to False in preprocessing notebook!")

modify_preprocessing_v4()
