...
def modify_preprocessing_v2():
    filepath = "02_preprocessing_prdect.ipynb"
    with open(filepath, 'r', encoding='utf-8') as f:
        nb = json.load(f)
    
    # Cell 9: Apply Cleaning, Label Mapping, Deduplication, and metadata prepending
    cell_9 = nb['cells'][9]
    cell_9_source = [
    ...
    print("Successfully modified preprocessing notebook Cell 9!")

modify_preprocessing_v2()
